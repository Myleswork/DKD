...
CFG.DATASET.AUTO_AUG = False
CFG.DATASET.CUT_OUT = False
...
CFG.SOLVER.LR_MIN = 1e-6  # 或其他合适的值
CFG.SOLVER.LR = 0.05
...
CFG.REVIEWKD.FEATURE_SIZE = [32, 16, 8, 4]   #用于RGA模块
CFG.REVIEWKD.MAX_MID_CHANNEL = 512
CFG.REVIEWKD.STU_PREACT = False

#RGA
CFG.RGA = CN()
CFG.RGA.SPATIAL = True
CFG.RGA.CHANNEL = True
